...
public class Trails extends Module {
    ...
    public void onRender3D(MatrixStack matrices, float tickDelta) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            buffer.vertex(matrix, (float) pt.pos.x, (float) (pt.pos.y + curW), (float) pt.pos.z).color(r, g, b, alpha).next();
            buffer.vertex(matrix, (float) pt.pos.x, (float) (pt.pos.y - (curW * 0.2f)), (float) pt.pos.z).color(r, g, b, 0).next();
        }
        tessellator.draw();
