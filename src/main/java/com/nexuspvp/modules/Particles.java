...
public class Particles extends Module {
    ...
    public static class VFXParticle {
        public Vec3d pos;
        public Vec3d vel;
        ...
        public float rotation = (float) (Math.random() * 360);
        public float rotSpeed = (float) ((Math.random() - 0.5) * 12);

        public VFXParticle(Vec3d pos, Vec3d vel, Color color, String style, float size, int maxAge) {
            this.pos = pos;
            this.vel = vel;
            this.color = color;
            this.style = style;
