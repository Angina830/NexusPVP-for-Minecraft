            ...
            for (StunZone zone : activeZones) {
                ...
                if (curStyle.equals("Cylinder") || curStyle.equals("Forcefield")) {
                    ...
                    for (int i = 0; i < segments; i++) {
                        ...
                        buffer.vertex(mat, x1, cy, z1).color(r, g, b, wallAlpha);
                        buffer.vertex(mat, x2, cy, z2).color(r, g, b, wallAlpha);
                        buffer.vertex(mat, x2, cy + h, z2).color(r, g, b, 0.0f);
                        buffer.vertex(mat, x1, cy + h, z1).color(r, g, b, 0.0f);
                    }
                ...
                for (int i = 0; i < segments; i++) {
                    ...
                    // Ground ring
                    lineBuffer.vertex(mat, x1, cy + 0.05f, z1).color(r, g, b, a);
                    lineBuffer.vertex(mat, x2, cy + 0.05f, z2).color(r, g, b, a);

                    // Waist ring
                    if (!curStyle.equals("Ring")) {
                        lineBuffer.vertex(mat, x1, cy + h * 0.5f, z1).color(r, g, b, a * 0.6f);
                        lineBuffer.vertex(mat, x2, cy + h * 0.5f, z2).color(r, g, b, a * 0.6f);
                    }
                }
                ...
                if (curStyle.equals("Wireframe") || curStyle.equals("Forcefield")) {
                    for (int i = 0; i < 16; i++) {
                        ...
                        lineBuffer.vertex(mat, px, cy, pz).color(r, g, b, a * 0.7f);
                        lineBuffer.vertex(mat, px, cy + h, pz).color(r, g, b, 0.0f);
                    }
                }
