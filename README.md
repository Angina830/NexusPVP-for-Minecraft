...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-v0.2.1-beta%20%5BNebula%5D-purple?style=for-the-badge" alt="Version" />
...
3. Скачайте `.jar` файл клиента нужной версии из раздела **[Releases](../../releases)**:
   - `NexusPVP-1.16.5-v0.2.1-beta [Nebula].jar`
   - `NexusPVP-1.20.1-v0.2.1-beta [Nebula].jar`
   - `NexusPVP-1.21.1-v0.2.1-beta [Nebula].jar`
